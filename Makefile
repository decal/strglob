...
LIBS = -lstrglob -L.
SRCS = count_commas.c count_strglob.c count_strptrs.c main_function.c show_strglob.c showall_strglob.c array_range.c show_usage.c integer_length.c strglob_error.c open_bracket.c open_brace.c next_string.c char_class.c open_paren.c string_class.c write_strptrs.c set_difer.c set_union.c dis_union.c
OBJS = $(SRCS:.c=.o) 
EXE = strglob
CFLAGS_SHARED = -fPIC
CFLAGS_STATIC = -fPIC
