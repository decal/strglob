...
CC = gcc
INSTALL = install
CFLAGS = -g -fPIC -Wall -pedantic -std=c11 -I. -O0 -DSTRGLOB_ENVIRON_EXPAND -DSTRGLOB_FILE_INCLUDES # -D_FORTITY_SOURCE=2 -fstack-check -fstack-protector-all -fsanitize=alignment -D_ISOC99_SOURCE -DDEBUG_STRGLOB
LIBS = -lstrglob -L.
